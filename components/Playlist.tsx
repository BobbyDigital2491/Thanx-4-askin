...
const cards = [
  {
    ...
    content: () => (
      <p>
        ...
        her melancholic and cinematic music style. Born Elizabeth Woolridge Grant
        in New York City, she has captivated audiences worldwide with her
  ...
  // ... the other three cards remain the same
  // (omitted here for brevity — copy them from your original code)
];
